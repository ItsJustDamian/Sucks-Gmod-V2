...
{
	Vertex_t() {}
	Vertex_t(void* &pos, void* &coord)
	{
		m_Position = pos;
		m_TexCoord = coord;
	}
	void Init(void* &pos, void* &coord)
	{
		m_Position = pos;
		m_TexCoord = coord;
	}
...
public:
	...
	virtual void SetEmbeddedPanel(void* pPanel) = 0;
	...
	virtual void SetAsTopMost(void* panel, bool state) = 0;
	virtual void BringToFront(void* panel) = 0;
	virtual void SetForegroundWindow(void* panel) = 0;
	virtual void SetPanelVisible(void* panel, bool state) = 0;
	virtual void SetMinimized(void* panel, bool state) = 0;
	virtual bool IsMinimized(void* panel) = 0;
	virtual void FlashWindow(void* panel, bool state) = 0;
	virtual void SetTitle(void* panel, const wchar_t *title) = 0;
	virtual void SetAsToolBar(void* panel, bool state) = 0;		// removes the window's task bar entry (for context menu's, etc.)
	...
	virtual void SwapBuffers(void* panel) = 0;
	...
	virtual void RestrictPaintToSinglePanel(void* panel) = 0;

	// these two functions obselete, use IInput::SetAppModalSurface() instead
	virtual void SetModalPanel(void*) = 0;
	...
	virtual void SetTopLevelFocus(void* panel) = 0;
	...
	virtual void SetNotifyIcon(void* context, HTexture icon, void* panelToReceiveMessages, const char *text) = 0;
	...
	virtual bool RecreateContext(void* panel) = 0;
	...
	virtual void PaintTraverse(void* panel) = 0;
	...
	virtual const wchar_t *GetTitle(void* panel) = 0;
